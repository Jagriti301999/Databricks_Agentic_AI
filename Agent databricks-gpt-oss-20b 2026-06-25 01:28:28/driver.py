...
# MAGIC
# MAGIC  **_NOTE:_**  This notebook uses the OpenAI SDK, but AI Agent Framework is compatible with any agent authoring framework, including LlamaIndex or LangGraph. To learn more, see the [Authoring Agents](https://docs.databricks.com/gcp/generative-ai/agent-framework/author-agent) Databricks documentation.
# MAGIC
# MAGIC ## Prerequisites
# MAGIC
...
# MAGIC
# MAGIC For more examples of tools to add to your agent, see [docs](https://docs.databricks.com/gcp/generative-ai/agent-framework/agent-tool.html).
...
# MAGIC ## https://docs.databricks.com/gcp/generative-ai/agent-framework/agent-tool.html
# MAGIC ###############################################################################
...
# MAGIC UC_TOOL_NAMES = ["agentic_catalog.agentic_schema.get_service_history", "agentic_catalog.agentic_schema.get_return_policy"]
# MAGIC
...
# MAGIC # See [docs](https://docs.databricks.com/gcp/generative-ai/agent-framework/unstructured-retrieval-tools.html) for details
# MAGIC
# MAGIC # Use Databricks vector search indexes as tools
# MAGIC # See the [Databricks Documentation](https://docs.databricks.com/gcp/generative-ai/agent-framework/unstructured-retrieval-tools.html) for details
...
# MAGIC - **TODO**: If your Unity Catalog Function queries a [vector search index](https://docs.databricks.com/gcp/generative-ai/agent-framework/unstructured-retrieval-tools.html) or leverages [external functions](https://docs.databricks.com/gcp/generative-ai/agent-framework/external-connection-tools.html), you need to include the dependent vector search index and UC connection objects, respectively, as resources. See [docs](https://docs.databricks.com/gcp/generative-ai/agent-framework/log-agent.html#specify-resources-for-automatic-authentication-passthrough) for more details.
# MAGIC
...
# MAGIC %md
# MAGIC ## Evaluate the agent with [Agent Evaluation](https://docs.databricks.com/gcp/mlflow3/genai/eval-monitor)
# MAGIC
# MAGIC You can edit the requests or expected responses in your evaluation dataset and run evaluation as you iterate your agent, leveraging mlflow to track the computed quality metrics.
# MAGIC
# MAGIC Evaluate your agent with one of our [predefined LLM scorers](https://docs.databricks.com/gcp/mlflow3/genai/eval-monitor/predefined-judge-scorers), or try adding [custom metrics](https://docs.databricks.com/gcp/mlflow3/genai/eval-monitor/custom-scorers).
...
catalog = "agentic_catalog" #add manually schema catalog and model name
...
# MAGIC %md
# MAGIC Successfully registered model 'agentic_catalog.agentic_schema.customer_service_model'.
...
# MAGIC %md
# MAGIC /local_disk0/.ephemeral_nfs/envs/pythonEnv-8b7a7c92-7cdc-4b47-9f75-11d2e2da1b5c/lib/python3.10/site-packages/databricks/agents/deployments.py:641: UserWarning: This endpoint is being deployed without a feedback model, which has been deprecated.
# MAGIC For more information, see: https://docs.databricks.com/aws/en/generative-ai/agent-framework/feedback-model
# MAGIC   warnings.warn(
# MAGIC
# MAGIC     Deployment of agentic_catalog.agentic_schema.customer_service_model version 1 initiated.  This can take up to 15 minutes and the Review App & Query Endpoint will not work until this deployment finishes.
# MAGIC
# MAGIC     View status: https://8259551295636485.5.gcp.databricks.com/ml/endpoints/agents_agentic_catalog-agentic_schema-customer_service_model/?o=8259551295636485
# MAGIC     Review App: https://8259551295636485.5.gcp.databricks.com/ml/review-v2/0911ebb500b64f89821fabb632d3e37b/chat?o=8259551295636485
# MAGIC
# MAGIC You can refer back to the links above from the endpoint detail page at https://8259551295636485.5.gcp.databricks.com/ml/endpoints/agents_agentic_catalog-agentic_schema-customer_service_model/?o=8259551295636485.
# MAGIC
# MAGIC To set up monitoring for your deployed agent, see:
# MAGIC https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/production-monitoring
# MAGIC Deployment(model_name='agentic_catalog.agentic_schema.customer_service_model', model_version='1', endpoint_name='agents_agentic_catalog-agentic_schema-customer_service_model', served_entity_name='agentic_catalog-agentic_schema-customer_service_model_1', query_endpoint='https://8259551295636485.5.gcp.databricks.com/serving-endpoints/agents_agentic_catalog-agentic_schema-customer_service_model/served-models/agentic_catalog-agentic_schema-customer_service_model_1/invocations?o=8259551295636485', endpoint_url='https://8259551295636485.5.gcp.databricks.com/ml/endpoints/agents_agentic_catalog-agentic_schema-customer_service_model/?o=8259551295636485', review_app_url='https://8259551295636485.5.gcp.databricks.com/ml/review-v2/0911ebb500b64f89821fabb632d3e37b/chat?o=8259551295636485')
...
# MAGIC ## Next steps
# MAGIC
# MAGIC After your agent is deployed, you can chat with it in AI playground to perform additional checks, share it with SMEs in your organization for feedback, or embed it in a production application. See [docs](https://docs.databricks.com/gcp/generative-ai/deploy-agent.html) for details
